...
export const protobufPackage = "proto.user_role.v1";
...
export const GetUserRoleResponse: MessageFns<GetUserRoleResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetUserRoleResponse>, I>>(base?: I): GetUserRoleResponse {
    return GetUserRoleResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetUserRoleResponse>, I>>(object: I): GetUserRoleResponse {
    const message = createBaseGetUserRoleResponse();
...
function createBaseCreateUserRoleResponse(): CreateUserRoleResponse {
  return { userRole: undefined, errors: [] };
}

export const CreateUserRoleResponse: MessageFns<CreateUserRoleResponse> = {
  encode(message: CreateUserRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userRole !== undefined) {
      UserRole.encode(message.userRole, writer.uint32(10).fork()).join();
    }
    for (const v of message.errors) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateUserRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CreateUserRoleResponse {
    return {
      userRole: isSet(object.userRole) ? UserRole.fromJSON(object.userRole) : undefined,
      errors: globalThis.Array.isArray(object?.errors) ? object.errors.map((e: any) => ErrorMessage.fromJSON(e)) : [],
    };
  ...
  toJSON(message: CreateUserRoleResponse): unknown {
    const obj: any = {};
    if (message.userRole !== undefined) {
      obj.userRole = UserRole.toJSON(message.userRole);
    }
  ...
  create<I extends Exact<DeepPartial<CreateUserRoleResponse>, I>>(base?: I): CreateUserRoleResponse {
    return CreateUserRoleResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateUserRoleResponse>, I>>(object: I): CreateUserRoleResponse {
    const message = createBaseCreateUserRoleResponse();
    message.userRole = (object.userRole !== undefined && object.userRole !== null)
      ? UserRole.fromPartial(object.userRole)
      : undefined;
...
export const UpdateUserRoleResponse: MessageFns<UpdateUserRoleResponse> = {
  encode(message: UpdateUserRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateUserRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<UpdateUserRoleResponse>, I>>(base?: I): UpdateUserRoleResponse {
    return UpdateUserRoleResponse.fromPartial(base ?? ({} as any));
  },
...
function createBaseDeleteUserRoleResponse(): DeleteUserRoleResponse {
  return { success: false, errors: [] };
}

export const DeleteUserRoleResponse: MessageFns<DeleteUserRoleResponse> = {
  encode(message: DeleteUserRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    for (const v of message.errors) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteUserRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DeleteUserRoleResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      errors: globalThis.Array.isArray(object?.errors) ? object.errors.map((e: any) => ErrorMessage.fromJSON(e)) : [],
    };
  ...
  toJSON(message: DeleteUserRoleResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<DeleteUserRoleResponse>, I>>(base?: I): DeleteUserRoleResponse {
    return DeleteUserRoleResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteUserRoleResponse>, I>>(object: I): DeleteUserRoleResponse {
    const message = createBaseDeleteUserRoleResponse();
    message.success = object.success ?? false;
    message.errors = object.errors?.map((e) => ErrorMessage.fromPartial(e)) || [];
    return message;
...
export const UserRoleServiceServiceName = "proto.user_role.v1.UserRoleService";
export class UserRoleServiceClientImpl implements UserRoleService {
  ...
  GetUserRole(request: GetUserRoleRequest): Promise<GetUserRoleResponse> {
    ...
    return promise.then((data) => GetUserRoleResponse.decode(new BinaryReader(data)));
  }
