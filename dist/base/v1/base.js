...
export function filterOperatorFromJSON(object) {
    switch (object) {
        case 0:
        case "EQUAL":
...
export function filterOperatorToJSON(object) {
    switch (object) {
...
export function sortOrderFromJSON(object) {
    switch (object) {
        case 0:
        case "UNSPECIFIED":
...
export function sortOrderToJSON(object) {
    switch (object) {
...
export const CreateSuccess = {
    ...
    create(base) {
        return CreateSuccess.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCreateSuccess();
...
export const UpdateSuccess = {
    ...
    create(base) {
        return UpdateSuccess.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdateSuccess();
        message.success = object.success ?? false;
...
export const DeleteSuccess = {
    ...
    create(base) {
        return DeleteSuccess.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteSuccess();
        message.success = object.success ?? false;
