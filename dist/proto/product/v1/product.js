...
function createBaseDeleteProductResponse() {
    return { success: false, errors: [] };
}
exports.DeleteProductResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.success !== false) {
            writer.uint32(8).bool(message.success);
        }
    ...
    create(base) {
        return exports.DeleteProductResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteProductResponse();
        message.success = object.success ?? false;
...
exports.GetProductResponse = {
    ...
    create(base) {
        return exports.GetProductResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetProductResponse();
        message.product = (object.product !== undefined && object.product !== null)
...
exports.ProductServiceServiceName = "proto.product.v1.ProductService";
class ProductServiceClientImpl {
    ...
    GetProduct(request) {
        ...
        return promise.then((data) => exports.GetProductResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetProducts(request) {
    ...
    CreateProduct(request) {
        ...
        return promise.then((data) => exports.CreateProductResponse.decode(new wire_1.BinaryReader(data)));
    }
    UpdateProduct(request) {
        ...
        return promise.then((data) => exports.UpdateProductResponse.decode(new wire_1.BinaryReader(data)));
    }
    DeleteProduct(request) {
        ...
        return promise.then((data) => exports.DeleteProductResponse.decode(new wire_1.BinaryReader(data)));
    }
}
