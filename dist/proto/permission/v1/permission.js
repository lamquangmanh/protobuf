...
exports.PermissionServiceClientImpl = exports.PermissionServiceServiceName = exports.GetPermissionsByUserIdResponse = exports.GetPermissionsByUserIdRequest = exports.PermissionInfo = exports.DeletePermissionResponse = exports.UpdatePermissionResponse = exports.GetPermissionResponse = exports.CreatePermissionResponse = exports.DeletePermissionRequest = exports.UpdatePermissionRequest = exports.CreatePermissionRequest = exports.GetPermissionsResponse = exports.GetPermissionsRequest = exports.GetPermissionRequest = exports.UpdatePermissionData = exports.CreatePermissionData = exports.Permission = exports.protobufPackage = void 0;
const wire_1 = require("@bufbuild/protobuf/wire");
const base_1 = require("../../base/v1/base");
exports.protobufPackage = "proto.permission.v1";
...
exports.CreatePermissionResponse = {
    ...
    create(base) {
        return exports.CreatePermissionResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCreatePermissionResponse();
        message.permission = (object.permission !== undefined && object.permission !== null)
...
exports.GetPermissionResponse = {
    ...
    create(base) {
        return exports.GetPermissionResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetPermissionResponse();
        message.permission = (object.permission !== undefined && object.permission !== null)
...
function createBaseUpdatePermissionResponse() {
    return { success: false, errors: [] };
}
exports.UpdatePermissionResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.UpdatePermissionResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdatePermissionResponse();
...
exports.DeletePermissionResponse = {
    ...
    create(base) {
        return exports.DeletePermissionResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeletePermissionResponse();
        message.success = object.success ?? false;
...
exports.PermissionServiceServiceName = "proto.permission.v1.PermissionService";
class PermissionServiceClientImpl {
    ...
    GetPermission(request) {
        ...
        return promise.then((data) => exports.GetPermissionResponse.decode(new wire_1.BinaryReader(data)));
    }
    ...
    CreatePermission(request) {
        ...
        return promise.then((data) => exports.CreatePermissionResponse.decode(new wire_1.BinaryReader(data)));
    }
    UpdatePermission(request) {
        ...
        return promise.then((data) => exports.UpdatePermissionResponse.decode(new wire_1.BinaryReader(data)));
    }
    DeletePermission(request) {
        ...
        return promise.then((data) => exports.DeletePermissionResponse.decode(new wire_1.BinaryReader(data)));
    }
