...
exports.UserServiceClientImpl = exports.UserServiceServiceName = exports.ChangePasswordRequest = exports.GetUserResponse = exports.ChangePasswordResponse = exports.DeleteUserResponse = exports.UpdateUserResponse = exports.CreateUserResponse = exports.DeleteUserRequest = exports.UpdateUserRequest = exports.CreateUserRequest = exports.GetUsersResponse = exports.GetUsersRequest = exports.GetUserRequest = exports.UpdateUserData = exports.CreateUserData = exports.User = exports.UserStatus = exports.protobufPackage = void 0;
...
exports.protobufPackage = "proto.user.v1";
var UserStatus;
(function (UserStatus) {
    UserStatus[UserStatus["USER_STATUS_UNSPECIFIED"] = 0] = "USER_STATUS_UNSPECIFIED";
    UserStatus[UserStatus["USER_STATUS_ACTIVE"] = 1] = "USER_STATUS_ACTIVE";
    UserStatus[UserStatus["USER_STATUS_DEACTIVATED"] = 2] = "USER_STATUS_DEACTIVATED";
    UserStatus[UserStatus["USER_STATUS_DELETED"] = 3] = "USER_STATUS_DELETED";
...
exports.ChangePasswordResponse = {
    ...
    create(base) {
        return exports.ChangePasswordResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseChangePasswordResponse();
        message.success = object.success ?? false;
...
exports.UserServiceServiceName = "proto.user.v1.UserService";
class UserServiceClientImpl {
    ...
    GetUser(request) {
        ...
        return promise.then((data) => exports.GetUserResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetUsers(request) {
    ...
    CreateUser(request) {
        ...
        return promise.then((data) => exports.CreateUserResponse.decode(new wire_1.BinaryReader(data)));
    }
    UpdateUser(request) {
    ...
    ChangePassword(request) {
        ...
        return promise.then((data) => exports.ChangePasswordResponse.decode(new wire_1.BinaryReader(data)));
    }
}
