...
exports.AuthServiceClientImpl = exports.AuthServiceServiceName = exports.VerifyResponse = exports.VerifyRequest = exports.GetMeResponse = exports.GetMeRequest = exports.LoginResponse = exports.LoginRequest = exports.Auth = exports.User = exports.protobufPackage = void 0;
const wire_1 = require("@bufbuild/protobuf/wire");
const base_1 = require("../../base/v1/base");
exports.protobufPackage = "proto.auth.v1";
...
exports.Auth = {
    ...
    create(base) {
        return exports.Auth.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAuth();
...
exports.LoginResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.auth !== undefined) {
            exports.Auth.encode(message.auth, writer.uint32(10).fork()).join();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.auth = exports.Auth.decode(reader, reader.uint32());
                    continue;
                }
                case 2: {
                    if (tag !== 18) {
    ...
    fromJSON(object) {
        return {
            auth: isSet(object.auth) ? exports.Auth.fromJSON(object.auth) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.auth !== undefined) {
            obj.auth = exports.Auth.toJSON(message.auth);
        }
    ...
    fromPartial(object) {
        const message = createBaseLoginResponse();
        message.auth = (object.auth !== undefined && object.auth !== null) ? exports.Auth.fromPartial(object.auth) : undefined;
...
exports.AuthServiceServiceName = "proto.auth.v1.AuthService";
