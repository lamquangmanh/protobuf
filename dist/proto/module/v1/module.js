...
exports.ModuleServiceClientImpl = exports.ModuleServiceServiceName = exports.GetModuleResponse = exports.DeleteModuleResponse = exports.UpdateModuleResponse = exports.CreateModuleResponse = exports.DeleteModuleRequest = exports.UpdateModuleRequest = exports.CreateModuleRequest = exports.GetModulesResponse = exports.GetModulesRequest = exports.GetModuleRequest = exports.UpdateModuleData = exports.CreateModuleData = exports.Module = exports.protobufPackage = void 0;
const wire_1 = require("@bufbuild/protobuf/wire");
const base_1 = require("../../base/v1/base");
exports.protobufPackage = "proto.module.v1";
...
function createBaseCreateModuleResponse() {
    return { module: undefined, errors: [] };
}
exports.CreateModuleResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.module !== undefined) {
    ...
    create(base) {
        return exports.CreateModuleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCreateModuleResponse();
        message.module = (object.module !== undefined && object.module !== null)
...
function createBaseUpdateModuleResponse() {
    return { success: false, errors: [] };
}
exports.UpdateModuleResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.UpdateModuleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdateModuleResponse();
...
function createBaseDeleteModuleResponse() {
    return { success: false, errors: [] };
}
exports.DeleteModuleResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.success !== false) {
            writer.uint32(8).bool(message.success);
        }
    ...
    create(base) {
        return exports.DeleteModuleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteModuleResponse();
        message.success = object.success ?? false;
...
function createBaseGetModuleResponse() {
    return { module: undefined, errors: [] };
}
exports.GetModuleResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.module !== undefined) {
            exports.Module.encode(message.module, writer.uint32(10).fork()).join();
        }
    ...
    create(base) {
        return exports.GetModuleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetModuleResponse();
        message.module = (object.module !== undefined && object.module !== null)
...
exports.ModuleServiceServiceName = "proto.module.v1.ModuleService";
class ModuleServiceClientImpl {
    ...
    GetModule(request) {
        ...
        return promise.then((data) => exports.GetModuleResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetModules(request) {
    ...
    CreateModule(request) {
        ...
        return promise.then((data) => exports.CreateModuleResponse.decode(new wire_1.BinaryReader(data)));
    }
    UpdateModule(request) {
        ...
        return promise.then((data) => exports.UpdateModuleResponse.decode(new wire_1.BinaryReader(data)));
    }
    DeleteModule(request) {
        ...
        return promise.then((data) => exports.DeleteModuleResponse.decode(new wire_1.BinaryReader(data)));
    }
}
