...
exports.CreateRoleResponse = {
    ...
    create(base) {
        return exports.CreateRoleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCreateRoleResponse();
...
function createBaseUpdateRoleResponse() {
    return { success: false, errors: [] };
}
exports.UpdateRoleResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.UpdateRoleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdateRoleResponse();
...
exports.DeleteRoleResponse = {
    ...
    create(base) {
        return exports.DeleteRoleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteRoleResponse();
        message.success = object.success ?? false;
...
exports.GetRoleResponse = {
    ...
    create(base) {
        return exports.GetRoleResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetRoleResponse();
        message.role = (object.role !== undefined && object.role !== null) ? exports.Role.fromPartial(object.role) : undefined;
...
exports.RoleServiceServiceName = "proto.role.v1.RoleService";
class RoleServiceClientImpl {
    ...
    GetRole(request) {
        ...
        return promise.then((data) => exports.GetRoleResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetRoles(request) {
    ...
    CreateRole(request) {
        ...
        return promise.then((data) => exports.CreateRoleResponse.decode(new wire_1.BinaryReader(data)));
    }
    UpdateRole(request) {
        const data = exports.UpdateRoleRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateRole", data);
        return promise.then((data) => exports.UpdateRoleResponse.decode(new wire_1.BinaryReader(data)));
    }
    DeleteRole(request) {
        const data = exports.DeleteRoleRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "DeleteRole", data);
        return promise.then((data) => exports.DeleteRoleResponse.decode(new wire_1.BinaryReader(data)));
    }
}
