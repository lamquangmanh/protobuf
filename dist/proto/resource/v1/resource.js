...
exports.CreateResourceResponse = {
    ...
    create(base) {
        return exports.CreateResourceResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCreateResourceResponse();
        message.resource = (object.resource !== undefined && object.resource !== null)
...
exports.UpdateResourceResponse = {
    ...
    create(base) {
        return exports.UpdateResourceResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdateResourceResponse();
...
exports.DeleteResourceResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.success !== false) {
            writer.uint32(8).bool(message.success);
        }
    ...
    create(base) {
        return exports.DeleteResourceResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteResourceResponse();
        message.success = object.success ?? false;
...
exports.GetResourceResponse = {
    ...
    create(base) {
        return exports.GetResourceResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetResourceResponse();
        message.resource = (object.resource !== undefined && object.resource !== null)
...
exports.ResourceServiceServiceName = "proto.resource.v1.ResourceService";
class ResourceServiceClientImpl {
    ...
    GetResource(request) {
        ...
        return promise.then((data) => exports.GetResourceResponse.decode(new wire_1.BinaryReader(data)));
    }
    ...
    CreateResource(request) {
        ...
        return promise.then((data) => exports.CreateResourceResponse.decode(new wire_1.BinaryReader(data)));
    }
    UpdateResource(request) {
        ...
        return promise.then((data) => exports.UpdateResourceResponse.decode(new wire_1.BinaryReader(data)));
    }
    DeleteResource(request) {
        ...
        return promise.then((data) => exports.DeleteResourceResponse.decode(new wire_1.BinaryReader(data)));
    }
}
