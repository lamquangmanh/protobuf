...
exports.MenuServiceClientImpl = exports.MenuServiceServiceName = exports.GetSuperMenusResponse = exports.GetSuperMenusRequest = exports.SuperMenu = exports.Menu = exports.SubMenu = exports.protobufPackage = void 0;
const wire_1 = require("@bufbuild/protobuf/wire");
exports.protobufPackage = "proto.menu.v1";
...
function createBaseGetSuperMenusRequest() {
    return { userId: "" };
}
exports.GetSuperMenusRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.userId !== "") {
    ...
    create(base) {
        return exports.GetSuperMenusRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetSuperMenusRequest();
...
function createBaseGetSuperMenusResponse() {
    return { superMenus: [] };
}
exports.GetSuperMenusResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.GetSuperMenusResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetSuperMenusResponse();
...
exports.MenuServiceServiceName = "proto.menu.v1.MenuService";
class MenuServiceClientImpl {
    ...
    GetSuperMenus(request) {
        const data = exports.GetSuperMenusRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetSuperMenus", data);
        return promise.then((data) => exports.GetSuperMenusResponse.decode(new wire_1.BinaryReader(data)));
    }
}
