...
export declare const protobufPackage = "proto.menu.v1";
...
export declare const GetSuperMenusRequest: MessageFns<GetSuperMenusRequest>;
export declare const GetSuperMenusResponse: MessageFns<GetSuperMenusResponse>;
export interface MenuService {
    GetSuperMenus(request: GetSuperMenusRequest): Promise<GetSuperMenusResponse>;
}
export declare const MenuServiceServiceName = "proto.menu.v1.MenuService";
