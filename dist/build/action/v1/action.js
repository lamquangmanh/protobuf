...
exports.Action = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.actionRequestType !== 0) {
            writer.uint32(40).int32(message.actionRequestType);
        }
        if (message.url !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5: {
                    ...
                    message.actionRequestType = reader.int32();
                    continue;
                }
                case 6: {
                    if (tag !== 50) {
    ...
    fromJSON(object) {
        return {
            ...
            actionRequestType: isSet(object.actionRequestType) ? actionRequestTypeFromJSON(object.actionRequestType) : 0,
    ...
    toJSON(message) {
        ...
        if (message.actionRequestType !== 0) {
            obj.actionRequestType = actionRequestTypeToJSON(message.actionRequestType);
        }
        if (message.url !== "") {
            obj.url = message.url;
        }
    ...
    fromPartial(object) {
        ...
        message.actionRequestType = object.actionRequestType ?? 0;
...
function createBaseCreateActionData() {
    return { resourceId: "", name: "", description: "", actionRequestType: 0, url: "", method: "" };
}
exports.CreateActionData = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.actionRequestType !== 0) {
            writer.uint32(32).int32(message.actionRequestType);
        }
        if (message.url !== "") {
